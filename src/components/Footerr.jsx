...
function Footer() {
    return (
        <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg mt-auto w-full">
            <div className="container-full px-4 py-6">
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    <div className="mb-6 lg:mb-0 w-full lg:w-1/4">
                        <div className="flex items-center text-lg font-bold mb-2 text-gray-900 dark:text-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full lg:w-auto">
                        <div>
                            <h3 className="font-semibold mb-3 text-gray-900 dark:text-white">Hakkında</h3>
                            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                                <li>
                                    <Link to="/home" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors flex items-center gap-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-3 text-gray-900 dark:text-white">Güvenlik</h3>
                            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                                <li>
                                    <Link to="/home" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors flex items-center gap-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-3 text-gray-900 dark:text-white">Destek Ol</h3>
                            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                                <li>
                                    <Link to="/home" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors flex items-center gap-2">
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center">
